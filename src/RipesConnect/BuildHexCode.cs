...
namespace RipesConnect
{
    public class BuildHexCode
    {
        ...
        /// <summary>
        /// Baut die .mem Datei mithilfe der installierten Toolchain.
        /// </summary>
        /// <param name="gccPath">Der Pfad zur 'riscv-none-elf-gcc' Executable (aus den Settings).</param>
        /// <param name="asmFilePath">Die zu kompilierende Datei.</param>
        /// <param name="outputService">Logger.</param>
